...
complete -c qrab -n "__fish_qrab_using_subcommand help; and not __fish_seen_subcommand_from check compile install-skill help" -f -a "check" -d 'Check a circuit without rendering it'
complete -c qrab -n "__fish_qrab_using_subcommand help; and not __fish_seen_subcommand_from check compile install-skill help" -f -a "compile" -d 'Compile a circuit to LaTeX, Typst, SVG, Quirk, or all of them'
complete -c qrab -n "__fish_qrab_using_subcommand help; and not __fish_seen_subcommand_from check compile install-skill help" -f -a "install-skill" -d 'Install the qrab agent skill in the current project'
complete -c qrab -n "__fish_qrab_using_subcommand help; and not __fish_seen_subcommand_from check compile install-skill help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
