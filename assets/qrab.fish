...
complete -c qrab -n "__fish_qrab_needs_command" -f -a "compile" -d 'Compile a circuit to LaTeX, Typst, or both'
...
complete -c qrab -n "__fish_qrab_using_subcommand help; and not __fish_seen_subcommand_from check compile help" -f -a "compile" -d 'Compile a circuit to LaTeX, Typst, or both'
