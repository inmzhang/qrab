...
- [x] Phase 4 — port all 44 qpic golden tests and 64 documented examples to `.qrab`; compile every fixture through Tectonic and Typst/Quill and add tolerant page-geometry regression baselines. All 108 qpic translations, their 216 PDF builds, and 12 representative geometry baselines are complete.
