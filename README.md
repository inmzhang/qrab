...
See [examples/styling.qrab](examples/styling.qrab) for portable layout and styling, and [examples/lifecycle.qrab](examples/lifecycle.qrab) for wire changes, labels, spacing, and persistent permutations.
